    ...
    <div id="professionalExperienceContainer">
      ...
      <div id="experienceList">
        <CardItem
          ...
          content={`Après plus de 10 ans d'expérience professionnelle, j'ai entrepris
        une transition majeure vers le développement web. Diplômé d'un titre
        professionnel DWWM en octobre 2023, je suis désormais passionné par
        la création d'expériences web innovantes.`}
        />
        <CardItem
          title={"RQTH - Reconnaissance de la Qualité de Travailleur Handicapé"}
          content={`Suite à un sérieux accident de travail à mon dernier poste, j'ai
        ...
        <CardItem
          ...
          content={`Actuellement à la recherche de ma première réelle expérience en tant
...
perspectives et enrichira davantage mes compétences.`}
        ...
        <CardItem
          ...
          content={`Téléchargez mon CV pour en savoir plus sur mon parcours
